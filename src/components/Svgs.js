    ...
    render() {
        return (
            <section className='icon'>
                ...
                <svg className='circle' width="50" height="50" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="75" cy="75" r="75" fill="#1A73E8"/>
                </svg>
                <svg className='rectangle' width="245" height="240" viewBox="0 0 455 350" fill="none" xmlns="http://www.w3.org/2000/svg">
